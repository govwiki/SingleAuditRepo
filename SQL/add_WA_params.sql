...
INSERT INTO script_parameters (category, `key`, value, description) VALUES ('washington', 'fs_directory_prefix', 'Unclassified/test_va', 'File Storage base folder for uploads (leave blank to upload to general storage)');
