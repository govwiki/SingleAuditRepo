...
INSERT INTO script_parameters (category, `key`, value, description) VALUES ('illinoid', 'start_from', '00100000', 'continue download from this item');
INSERT INTO script_parameters (category, `key`, value, description) VALUES ('illinoid', 'illinois_entities_xlsx_file', 'Illinois Entities.xlsx', 'make sure that file with entities is placed in dir_in directory');
INSERT INTO script_parameters (category, `key`, value, description) VALUES ('illinoid', 'illinois_entities_sheet', 'Sheet1', 'workbook sheet');